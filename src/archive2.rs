...
// Derived from:
// * https://github.com/llvm/llvm-project/blob/8ef3e895ad8ab1724e2b87cabad1dacdc7a397a3/llvm/include/llvm/Support/Alignment.h
// * https://github.com/llvm/llvm-project/blob/8ef3e895ad8ab1724e2b87cabad1dacdc7a397a3/llvm/include/llvm/Object/Archive.h
...
fn offset_to_alignment(value: u64, alignment: u64) -> u64 {
...
fn is_64bit_kind(kind: ArchiveKind) -> bool {
    match kind {
        ...
        ArchiveKind::Gnu64 | ArchiveKind::Darwin64 => true,
    }
}
        ...
        Ok(file) => {
            *has_object = true;
            ...
            for sym in file.symbols() {
                ...
                sym_names.write_all(sym.name_bytes().expect("TODO"))?;
